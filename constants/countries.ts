// ISO 3166-1 country list (Alpha-3 code -> country name)
// Source: https://www.iban.com/country-codes (fetched 2026-02-12)
...
export const COUNTRIES_ALPHA3: CountryOption[] = [
...
export const getCountryName = (code: string): string | null => {
  return COUNTRIES_ALPHA3.find((c) => c.code === code)?.name ?? null;
};
