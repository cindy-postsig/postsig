...
interface Table_public_contract_docs {
  id: number;
...
interface Table_public_vendors {
  id: number;
  name: string | null;
  address: string | null;
  email: string | null;
...
interface Schema_public {
  contract_docs: Table_public_contract_docs;
  contracts: Table_public_contracts;
  vendors: Table_public_vendors;
}
interface Schema_realtime {}
...
interface Tables_relationships {
  ...
  'public.contract_docs': {
    parent: {
      contract_docs_contract_id_fkey: 'public.contracts';
    };
    children: {};
  };
  'public.contracts': {
    parent: {
      contracts_user_id_fkey: 'auth.users';
      contracts_vendor_id_fkey: 'public.vendors';
    };
    children: {
      contract_docs_contract_id_fkey: 'public.contract_docs';
    };
  };
  'auth.flow_state': {
    parent: {};
  ...
  'auth.users': {
    ...
    children: {
      ...
      contracts_user_id_fkey: 'public.contracts';
    };
  };
  'public.vendors': {
    parent: {};
    children: {
      contracts_vendor_id_fkey: 'public.contracts';
    };
  };
}
//#endregion
...
type ColumnWithCallback<
  TSchema extends keyof Database,
  TTable extends keyof Database[TSchema],
> = {
...
type SelectedTablesWithRelationsIds<
  TSelectedTable extends SelectedTable['id'],
...
type FollowNullableRelationsOptions<TSelectedTable extends SelectedTable> =
  ...
  | ({ $default: boolean } & {
      ...
      [TTable in SelectedTablesWithRelationsIds<TSelectedTable['id']>]?:  // It's either a boolean or a mix of $default and relationship specific definition
        ...
        | {
            [Key in
              | GetSelectedTableRelationsKeys<TTable>
              | '$default']?: boolean;
          };
    });
  ...
  GetSelectedTable<ApplyDefault<TSelectConfig>> extends SelectedTable
    ? {
        ...
        transform?: TransformConfig<
          TTransformMode,
          GetSelectedTable<ApplyDefault<TSelectConfig>>
        >;
        /**
