...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('font-medium py-1.5 pl-8 pr-2 text-sm', className)}
    {...props}
  />
));
