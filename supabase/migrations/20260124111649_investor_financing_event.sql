...
create sequence "public"."investor_stages_id_seq";

drop view if exists "public"."investor_party_summary";

drop view if exists "public"."investor_portfolio_metrics";

drop index if exists "public"."investor_financing_event_event_type_idx";
  ...
  create table "public"."investor_stages" (
    "id" bigint not null default nextval('public.investor_stages_id_seq'::regclass),
...
alter table "public"."investor_financing_event" drop column "event_type";

alter table "public"."investor_financing_event" drop column "round_name";

alter table "public"."investor_financing_event" add column "event_type_id" bigint;

alter table "public"."investor_financing_event" add column "stage_id" bigint;

alter sequence "public"."investor_events_id_seq" owned by "public"."investor_events"."id";

alter sequence "public"."investor_stages_id_seq" owned by "public"."investor_stages"."id";

CREATE INDEX idx_investor_financing_event_event_type_id ON public.investor_financing_event USING btree (event_type_id);

CREATE INDEX idx_investor_financing_event_stage_id ON public.investor_financing_event USING btree (stage_id);

CREATE UNIQUE INDEX investor_events_event_key_key ON public.investor_events USING btree (event_key);

CREATE UNIQUE INDEX investor_events_pkey ON public.investor_events USING btree (id);

CREATE UNIQUE INDEX investor_stages_pkey ON public.investor_stages USING btree (id);

CREATE UNIQUE INDEX investor_stages_stage_key_unique ON public.investor_stages USING btree (stage_key);

alter table "public"."investor_events" add constraint "investor_events_pkey" PRIMARY KEY using index "investor_events_pkey";

alter table "public"."investor_stages" add constraint "investor_stages_pkey" PRIMARY KEY using index "investor_stages_pkey";

alter table "public"."investor_events" add constraint "investor_events_event_key_key" UNIQUE using index "investor_events_event_key_key";

alter table "public"."investor_financing_event" add constraint "investor_financing_event_event_type_id_fkey" FOREIGN KEY (event_type_id) REFERENCES public.investor_events(id) not valid;

alter table "public"."investor_financing_event" validate constraint "investor_financing_event_event_type_id_fkey";

alter table "public"."investor_financing_event" add constraint "investor_financing_event_stage_id_fkey" FOREIGN KEY (stage_id) REFERENCES public.investor_stages(id) not valid;

alter table "public"."investor_financing_event" validate constraint "investor_financing_event_stage_id_fkey";

alter table "public"."investor_stages" add constraint "investor_stages_stage_key_unique" UNIQUE using index "investor_stages_stage_key_unique";
...
grant delete on table "public"."investor_stages" to "anon";

grant insert on table "public"."investor_stages" to "anon";

grant references on table "public"."investor_stages" to "anon";

grant select on table "public"."investor_stages" to "anon";

grant trigger on table "public"."investor_stages" to "anon";

grant truncate on table "public"."investor_stages" to "anon";

grant update on table "public"."investor_stages" to "anon";

grant delete on table "public"."investor_stages" to "authenticated";

grant insert on table "public"."investor_stages" to "authenticated";

grant references on table "public"."investor_stages" to "authenticated";

grant select on table "public"."investor_stages" to "authenticated";

grant trigger on table "public"."investor_stages" to "authenticated";

grant truncate on table "public"."investor_stages" to "authenticated";

grant update on table "public"."investor_stages" to "authenticated";
...
grant delete on table "public"."investor_stages" to "service_role";

grant insert on table "public"."investor_stages" to "service_role";

grant references on table "public"."investor_stages" to "service_role";

grant select on table "public"."investor_stages" to "service_role";

grant trigger on table "public"."investor_stages" to "service_role";

grant truncate on table "public"."investor_stages" to "service_role";

grant update on table "public"."investor_stages" to "service_role";
